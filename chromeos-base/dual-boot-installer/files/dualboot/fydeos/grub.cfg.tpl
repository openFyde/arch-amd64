...
defaultA=0
defaultB=1
search --label --set dualboot_part FYDEOS-DUAL-BOOT
set img=($dualboot_part)/fydeos/fydeos_dual_boot.img
...
menuentry "FydeOS Recovery Tools" {
  ...
  linux /boot/fydeos_vmlinuzB init=/sbin/init boot=local rootwait noresume noswap ro loglevel=7 console= i915.modeset=1 cros_efi %EXTRA_FLAG%
